      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-center md:text-left">
            <h3 className="text-3xl font-black text-red-500 glow-red mb-2">AGENT TRIALS</h3>
        ...
        <div className="mt-8 pt-8 border-t border-red-900/20 text-center text-gray-600 text-sm">
          <p>© 2025 Agent Trials. All trades executed on-chain.</p>
        </div>
      </div>
    </footer>
  );
